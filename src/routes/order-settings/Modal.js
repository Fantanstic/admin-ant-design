    ...
    <Modal {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label="关键词" style={{ display: keywordVisible?'':'none' }} hasFeedback {...formItemLayout}>
          ...
          {console.log("urlVisible",urlVisible)}
        <FormItem label="URL" style={{ display: urlVisible?'':'none' }} hasFeedback {...formItemLayout}>
            {getFieldDecorator('app_url', {
                initialValue: item.app_url,
                rules: [
                    {
                        required: urlVisible? true:false,
                    },
                ],
            })(<Input   style={{ width: controlWidth }} />)}
        </FormItem>
